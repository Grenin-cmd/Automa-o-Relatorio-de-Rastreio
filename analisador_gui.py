...
class AnalizadorGUI:
    ...
    def _criar_widgets(self) -> None:
        ...
        tk.Label(frame, text="Arquivo CSV ou Excel:", font=(None, 10, "bold")).grid(row=0, column=0, sticky="w")
        ...
        tk.Label(frame, text="POIs (uma linha por item):", font=(None, 10, "bold")).grid(row=2, column=0, columnspan=2, sticky="w", pady=(16, 0))
        ...
        tk.Label(frame, text="Relatório de saída:", font=(None, 10, "bold")).grid(row=4, column=0, columnspan=2, sticky="w", pady=(16, 0))
